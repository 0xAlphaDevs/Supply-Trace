export const spContractAbi = [
  ...
  { inputs: [], name: "OffchainAttestationAlreadyRevoked", type: "error" },
  ...
  {
    inputs: [
      { internalType: "string[]", name: "attestationIds", type: "string[]" },
      { internalType: "address", name: "delegateAttester", type: "address" },
      { internalType: "bytes", name: "delegateSignature", type: "bytes" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint64", name: "attestationCounter_", type: "uint64" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
